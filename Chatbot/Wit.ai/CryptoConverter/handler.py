...
# Wit.ai parameters
WIT_TOKEN = os.environ.get('WIT_TOKEN') or '3VC4MHRBGZ4TQRXHEPLW463TDI7MQPK6'

# Messenger API parameters
FB_PAGE_TOKEN = os.environ.get('FB_PAGE_TOKEN') or \
'EAAGfoLsKsloBAIhAzH38jvoPH7WeaCzTosBYZBJbqFkUAseYNud1C6a5AtVaZCLd9lItjLH7U6QTr3ZAFS6VgfPZADu0GtoIIhuidvPqxtiLZCTZBUN9RGQ1goupZAOtGpTLDxeyZAlExZBLdtsadBmWCYc7pA3u4jHy63GvoPvPHYQZDZD'
# A user secret to verify webhook get request.
FB_VERIFY_TOKEN = os.environ.get('FB_VERIFY_TOKEN') or 'F96AB6A897D466604447C1D9A3CACAC4'
    ...
    if greetings:
        ...
        if first_entity_value(entities, 'intent') == 'convert' :
            ...
            if (crypto is not None) and (unit is not None) :
                qs = btc + '-' + crypto
                r = requests.get('https://api.cryptonator.com/api/ticker/btc-usd'+qs)
